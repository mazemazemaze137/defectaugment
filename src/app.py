...
def _health_rows():
    ...
    checks = [
        ...
        ("600张GAN子集", "results/ratio_ablation/cgan_v2_40ep_multiseed/subsets/gan_100_per_class"),
        ("三种子比例消融结果", "results/ratio_ablation/cgan_v2_40ep_multiseed/ratio_ablation_summary.csv"),
